    ...
    def train(self, model):
        ...
        for e in tqdm(range(start_epoch, total_epoch)):
            ...
            if (e + 1) % args.val_epoch == 0:
                ...
                logger.info('val_%d-way-%d-shot_acc2(lshot): %.3f\t%.3f' % (test_way, val_shot, mean2, interval2))
    ...
    def evaluate(self, model):
        ...
        with torch.no_grad():
            ...
            for shot in [1, 5]:
                ...
                logger.info('%d-way-%d-shot acc2(lshot): %.2f\t%.2f' % (args.test_way, shot, mean2, interval2))
