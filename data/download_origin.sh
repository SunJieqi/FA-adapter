...
# md5sum for the downloaded tiered-ImageNet_DeepEMD.tar should be 7828a6dc2889e226ba575d2ba9624753
echo "downloading images for tiered-ImageNet_DeepEMD..."
gdownload 1ANczVwnI1BDHIF65TgulaGALFnXBvRfs tiered-ImageNet_DeepEMD.tar
conditional_tar tiered-ImageNet_DeepEMD.tar 7828a6dc2889e226ba575d2ba9624753
if [ -d "tiered_imagenet" ] 
then
    mv tiered-ImageNet_DeepEMD tiered-ImageNet_DeepEMD
fi
